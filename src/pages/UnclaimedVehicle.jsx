...
import useUnclaimedVehicle from "../hooks/useUnclaimedVehicle";
...
export default function UnclaimedVehicle() {
  ...
  const { data, loading, deleteItem, updateItem } = useUnclaimedVehicle();
    ...
    <>
      <div className="w-full mx-auto p-4 rounded-lg text-sm">
        <h2 className="text-lg font-semibold mb-4">
          {editingId
            ? "Update Unclaimed Vehicle Entry"
            : "Unclaimed Vehicle Entry"}
        </h2>
        <form
      ...
      {/* ____________________All Unclaimed Vehicle EntryData=------------ */}

      <div className="mt-6">
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-semibold mb-3">
            All Unclaimed Vehicle Entries
          </h2>
